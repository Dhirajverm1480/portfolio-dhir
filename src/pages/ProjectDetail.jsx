    ...
    <div className='page-frame'>
      <div className='lg:flex justify-between border-b'>
        ...
        <div className='lg:w-[60%]'>
          ...
          <p id='subtitle' className='text-lg py-2'>{project.subtitle}</p>
          <p className='w-full flex flex-wrap  gap-3 text-gray-400'>{project.technologies.map((item, index) => (
            <span key={index}>{item}</span>
          ))}</p>
          <p id='description' className='text-sm py-2'>{project.description}</p>
          <div>
