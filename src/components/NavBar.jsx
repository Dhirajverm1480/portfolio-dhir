...
const NavBar = () => {
  ...
  return (
    <div className="sticky top-0 backdrop-blur-lg sm:backdrop-blur-0">
      <nav className="w-full flex justify-between items-center p-3">
        <div className="flex items-center gap-10">
          <img onClick={() => setVisible(true)} src={MenuImg} alt="" className="sm:hidden cursor-pointer" />
      ...
      <div className={`absolute top-0 left-0 bottom-0 overflow-hidden z-100 transition-all bg-[#000000e5] shadow-2xl ${visible ? 'w-full h-screen' : 'w-0'}`}>
